...
param vmName string = 'vm-monitoring-2022'
...
param publicIpAddressName string = 'vm-monitoring-public-access'

@description('DNS name for the IP')
param dnsNameForIp string = 'vm-monitoring-web'

param resourceTags object = {
  Description: 'VM setup monitoring basics demo'
   Environment: 'Demo'
   ResourceType: 'VM'
}
