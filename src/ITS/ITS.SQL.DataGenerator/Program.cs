...
if (string.IsNullOrEmpty(folderRoot))
{
    var pathToDownload = Environment.GetEnvironmentVariable("DOWNLOADURL") ??
                         "https://github.com/vrhovnik/azure-demo-monitoring-basics/archive/refs/heads/main.zip";
    ...
    folderRoot = "src/azure-demo-monitoring-basics";
}
...
if (AnsiConsole.Profile.Capabilities.Links)
    AnsiConsole.MarkupLine(
        "Check [link=https://https://github.com/azure-demo-monitoring-basics] for more information[/]");
